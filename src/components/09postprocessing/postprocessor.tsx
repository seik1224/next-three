  ...
  return (
    <>
      <EffectComposer>
        ...
        {/* 지지직 거리는 효과 */}
        {/* <Glitch
          delay={new Vector2(1.5, 3.5)} // 글리치 기능의 시간 지연의 최솟 최댓 값
          duration={new Vector2(0.5, 1.0)} // 글리치 기능이 일어나는 시간의 최솟 최댓 값
          strength={new Vector2(0.01, 1.0)} // 글리치 기능의 강도의 최솟 최댓 값
